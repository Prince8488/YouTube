  ...
  return (
    <div className=" fixed bg-white dark:bg-black z-50 w-full top-0 left-0 grid grid-flow-col p-2 max-sm:shadow">
      <div className="flex col-span-1">
        <div
          onClick={handleMenuhandler}
          className="w-12 h-12 py-5 ml-3 cursor-pointer"
        ...
        <div>
          <svg
            ...
            focusable="false"
            aria-hidden="true"
            className="w-32 h-16 max-sm:w-24"
          >
            <svg
      ...
      <div className="flex col-span-1  max-sm:justify-end">
        ...
        >
          <img
            ...
            src="https://yt3.ggpht.com/yti/ANjgQV9UxuNCL4HC74Tp5y6Lqs18m6zwKo6r1Ca1rvlRrXvrG08=s88-c-k-c0x00ffffff-no-rj"
            alt="user"
          />
          <div className="font-medium dark:text-white max-sm:hidden">
            <div>Prince Gupta</div>
        ...
        {userProfile && (
          <div
            id="userDropdown"
            className="absolute z-auto mt-20 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600"
          >
            <div className="flex">
              <label className="inline-flex items-center ml-4 m-0 h-0 mt-7">
                <input type="checkbox" value="" className="sr-only peer" />
                <div
                  className="relative w-11 h-6 bg-black peer-focus:outline-none rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-black after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white dark:after:bg-black after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-white"
                  onClick={() => handleMode()}
                ></div>
                <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300"></span>
              </label>
              <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300 mt-4">
